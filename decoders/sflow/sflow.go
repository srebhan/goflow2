...
const (
	// According to https://sflow.org/SFLOW-STRUCTS5.txt
...
// Deprecated: FORMAT_* definitions are mixing sample-format, flow-data type and
// counter-data type definitions. Those are left here for compatibility.
//
